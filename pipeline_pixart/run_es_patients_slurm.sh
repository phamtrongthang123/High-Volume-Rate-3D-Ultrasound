...
# Run DPS reconstruction for all 45 CETUS patients (ES phase).
# Submit with: sbatch pipeline_pixart/run_es_patients_slurm.sh
# Run after ED phase (run_all_patients_slurm.sh) completes.
